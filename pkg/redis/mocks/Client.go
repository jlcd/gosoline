...
// LMPop provides a mock function with given fields: ctx, direction, count, key
func (_m *Client) LMPop(ctx context.Context, direction string, count int64, key string) (string, []string, error) {
	ret := _m.Called(ctx, direction, count, key)

	var r0 string
	var r1 []string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, string) (string, []string, error)); ok {
		return rf(ctx, direction, count, key)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, string) string); ok {
		r0 = rf(ctx, direction, count, key)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, int64, string) []string); ok {
		r1 = rf(ctx, direction, count, key)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]string)
		}
...
// Client_LMPop_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LMPop'
type Client_LMPop_Call struct {
	*mock.Call
}
...
//   - count int64
//   - key string
func (_e *Client_Expecter) LMPop(ctx interface{}, direction interface{}, count interface{}, key interface{}) *Client_LMPop_Call {
	return &Client_LMPop_Call{Call: _e.mock.On("LMPop", ctx, direction, count, key)}
}

func (_c *Client_LMPop_Call) Run(run func(ctx context.Context, direction string, count int64, key string)) *Client_LMPop_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_LMPop_Call) Return(_a0 string, _a1 []string, _a2 error) *Client_LMPop_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *Client_LMPop_Call) RunAndReturn(run func(context.Context, string, int64, string) (string, []string, error)) *Client_LMPop_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) LRange(ctx context.Context, key string, start int64, stop int64) ([]string, error) {
...
func (_c *Client_LRange_Call) Return(_a0 []string, _a1 error) *Client_LRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_LRange_Call) RunAndReturn(run func(context.Context, string, int64, int64) ([]string, error)) *Client_LRange_Call {
	_c.Call.Return(run)
	return _c
}
